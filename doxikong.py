...
| $$    $$ \$$    $$|  $$ \$$\|   $$ \| $$  \$$\ \$$    $$| $$  | $$ \$$    $$
 \$$$$$$$   \$$$$$$  \$$   \$$ \$$$$$$ \$$   \$$  \$$$$$$  \$$   \$$ _\$$$$$$$
     ...
     \033[1;31mDoxIkong\033[1;m \033[1;34mBY\033[1;m https://cracked.to/ANG \033[1;33mVersion:\033[1;32m Beta 1.0\033[1;35m
     """
...
\033[1;36m       99. About
	...
	if OPT == "1":
		...
		KURO()
		webbrowser.open('https://cracked.to/ANG')
		menu()
	else:
		KURO()
		LOGO()
...
def ID():
	...
	LOGO()  
	time.sleep(1)
	Name = raw_input(" First Name:\033[1;m ")
	F_name = raw_input("\033[1;35m Last name:\033[1;m ")
...
def EXITMENU():
	...
	LOGO()
	time.sleep(1)
	print "\033[1;m Thanks for using DoxIkong\033[1;m"
	time.sleep(2)
	print
